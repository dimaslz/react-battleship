...
export { default as setHorizontalBoatPosition } from './set-horizontal-boat-position.method';
export { default as setVerticalBoatPosition } from './set-vertical-boat-position.method';
